...
##Model
-Weekly aggregation with lags for stock and price variables.
...
```
##Model
Linear regression with ARIMA errors for product id 26104
```{r}
(model.exo26104)
# (model.exo158105)
# (model.exo158737)
...
##Model
Linear regression with ARIMA errors for product id 158105
```{r}
# (model.exo26104)
(model.exo158105)
# (model.exo158737)
...
p<-ggplot(plotfun)+
  ...
  scale_colour_manual("", 
                      ...
                      values = c("tomato1", "royalblue1", "gray80"))
